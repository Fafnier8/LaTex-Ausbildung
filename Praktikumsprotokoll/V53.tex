    ...
    \section{Theorie}
        ...
        \subsection{Stehwellenverhältnis (SWR)}
            ...
            %\subsubsection{Abschwächer-Methode}
                ...
                %Hierbei wird ein Abschwächer genutzt, welcher das Ausgangssignal vom Maximum und Minimum angleicht. % Formulierung vllt. noch etwas überarbeiten
...
%
    \section{Aufbau}
        ...
        %Außerdem werden ein Frequenzmessgerät, Dämfungsglied, Stehwellendetektor, ein Abschluss und ein verstellbarer Kurzschluss, ein Gleitschraubentransformator, ein Abgeschlossener Hohlleiter mit Diodendetektor und zuletzt ein SWR-Meter und ein Oszilloskop gebraucht.

        %Dieser ist ein Hohlleiter mit einem verschiebbaren Diodendetektor.
        %
        %Der Abschluss, oder auch Wellensumpf genannt, ist ein Bauteil welches die Mikrowellenstrahlung komplett absorbiert.
        %Der Kurzschluss hingegen soll möglichst die gesamte Amplitude der Strahlung reflektieren.
        %
        %Dieser ist ein Hohlleiter mit einer Öffnung in der eine Schraube eingelassen ist, welche sich mit einer Genauigkeit im $\si{\milli\meter}$-Bereich in den Hohlleiter einführen lässt.
        
        %Für alle Versuchsaufbauten muss zunächst das Klystron-Netzteil an das Klystron angeschlossen werden.
        %Hierbei muss darauf geachtet werden, dass der Ausgang der Beschleunigungsspannung und der Reflektorspannung korrekt angeschlossen sind.

        %Als nächstes wird der Einweggleichrichter am Ausgang des Klystrons montiert.
        %Der Gleichrichter muss ausdrücklich als erstes Bauteil hinter dem Klystron montiert werden, unabhängig vom Versuchsaufbau, um Beschädigung des Geräts zu vermeiden.

        %Nun wird das Frequenzmessgerät an das Ende des Einweggleichrichters, und das Dämpfungsglied am Ende des Frequenzmessers angeschraubt.
        %Auch diese Bauteile sind für alle Messungen zu verwenden und es sollte für eine erfolgreiche Durchführung der Versuche auf die richtige Reihenfolge in der Montage geachtet werden.
...
%
    \section{Durchführung}
        ...
        %Nach dieser Wartezeit wird der zuvor genannte Knopf angeschaltet und mit der Messung begonnen.
        \subsection{Modenmessung}
